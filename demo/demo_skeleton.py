...
def parse_args():
    parser = argparse.ArgumentParser(description='stgcn++ demo')
    parser.add_argument('--video', default='../data/Weizmann/test/lyova_9.avi', help='video file/url')
    parser.add_argument('--out_filename', default='result.mp4', help='output filename')
    parser.add_argument(
        '--config',
    ...
    parser.add_argument(
        '--checkpoint',
        default='../result/best_top1_acc_epoch_63.pth',
        help='skeleton action recognition checkpoint file/url')


    parser.add_argument(
        '--det-config',
        default='faster_rcnn_r50_fpn_1x_coco-person.py',
    ...
    parser.add_argument(
        '--label-map',
        default='../tools/data/label_map/Weizmann.txt',
        help='label map file')
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    print('config:', config)
    GCN_flag = 'GCN' in config.model.type  # GCN是不是在字符串里
    GCN_nperson = None
    if GCN_flag:
